...
var Name="ScepterBall"
var WeaponDetectName="ScepterWeaponDetector"
var BallNum=0
...
func _ready():
	...
	Global.MapName.NumOfLabelsVisible(2,"Scepter")
	Global.MapName.ChangeOneLabel("Damage/Lifesteal: "+str(Damage),"Scepter")
	Global.MapName.ChangeTwoLabel("Damage Dealt: "+str(DamageDealt),"Scepter")
...
func _physics_process(delta):
	$ScepterWeaponDetector.rotate(deg_to_rad(delta*300*RotationDirection))
...
func _on_scepter_weapon_detector_body_entered(body: Node2D) -> void:
...
func _on_scepter_weapon_detector_area_entered(area: Area2D) -> void:
