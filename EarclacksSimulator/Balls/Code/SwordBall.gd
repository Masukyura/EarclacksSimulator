...
var Name="SwordBall"
var WeaponDetectName="SwordWeaponDetector"
var BallNum=0
...
func _ready():
	...
	Global.MapName.NumOfLabelsVisible(2,"Sword")
	Global.MapName.ChangeOneLabel("Damage: "+str(Damage),"Sword")
	Global.MapName.ChangeTwoLabel("Damage Dealt: "+str(DamageDealt),"Sword")
...
func _physics_process(delta):
	$SwordWeaponDetector.rotate(deg_to_rad(delta*300*RotationDirection))
...
func _on_sword_weapon_detector_body_entered(body: Node2D) -> void:
...
func _on_sword_weapon_detector_area_entered(area: Area2D) -> void:
